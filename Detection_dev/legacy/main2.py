    ...
    try:
        while cap.isOpened():
            ...
            if frameIndex == 0:
                ...
                # FOV 14
                detected_lines = [{'m': -0.6865203761755486, 'b': 553.9623824451411, 'x_bot': -764.1567398119122, 'abs_m': 0.6865203761755486}, {'m': 0.5127919911012235, 'b': 530.4404894327031, 'x_bot': 1515.0011123470522, 'abs_m': 0.5127919911012235}]
