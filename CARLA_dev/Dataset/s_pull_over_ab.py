...
def run(world, blueprint_library, duration_sec=30.0, output_dir=None):
    """Run a pull-over anomaly scenario with a single vehicle, with extra speeding.

    Spawns one car that cruises at a random speed, then pulls toward the
    road shoulder and brakes to a full stop. The scenario progresses
    through five phases: cruise, pull, straighten, brake, and stop.
