...
# Control 50
# VIDEO_PATH = os.path.join(DATA_DIR, "dataset/50_/50__Control.mp4")
# RADAR_CSV_PATH = os.path.join(DATA_DIR, "dataset/50_/50__Control--6.0.csv")

# Control 25
# VIDEO_PATH = os.path.join(DATA_DIR, "dataset/25_/25__Control.mp4")
# RADAR_CSV_PATH = os.path.join(DATA_DIR, "dataset/25_/25__Control--6.0.csv")
...
#special 
VIDEO_PATH = os.path.join(DATA_DIR, "dataset/rasp_dataset/12_AC.mp4")
RADAR_CSV_PATH = os.path.join(DATA_DIR, "dataset/rasp_dataset/12_AC---6.0.csv")



# # lane departure
# VIDEO_PATH = os.path.join(DATA_DIR, "dataset/alarm/5_B/5_B.mp4")
# RADAR_CSV_PATH = os.path.join(DATA_DIR, "dataset/alarm/5_B/5_B--6.0.csv")
...
# overtaking
# VIDEO_PATH = os.path.join(DATA_DIR, "dataset/alarm/4_C/4_C.mp4")
# RADAR_CSV_PATH = os.path.join(DATA_DIR, "dataset/alarm/4_C/4_C--6.0.csv")
...
OUTPUT_VIDEO_PATH = os.path.join(DATA_DIR, "output", "trajectory_speeding.mp4")
